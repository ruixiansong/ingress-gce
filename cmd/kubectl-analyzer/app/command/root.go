...
var rootCmd = &cobra.Command{
	Use:   "kubectl analyze",
	Short: "kubectl-config-analyzer is a kubectl tool to check the correctness of kubernetes resources.",
	Long:  "kubectl-config-analyzer is a kubectl tool to check the correctness of kubernetes resources.",
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Fprintf(os.Stderr, "Hello, this is kubectl-config-analyzer")
	},
}
